...
\n\n-- Drop existing policies if they exist\nDROP POLICY IF EXISTS "notifications_visibility_20250301" ON notifications;
\nDROP POLICY IF EXISTS "notification_visibility_policy" ON notifications;
\n\n-- Create RLS policy with a unique name\nCREATE POLICY "notification_access_policy_20250301"\n  ON notifications FOR SELECT\n  TO authenticated\n  USING (auth.uid() = user_id);
